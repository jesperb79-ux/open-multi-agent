/**
 * Feature flag för kartfunktionen.
 *
...
/**
 * Är kartfunktionen påslagen?
 *
 * Läses en gång vid start. Vite ersätter `import.meta.env` vid bygget, så en
 * avstängd flagga innebär att kartkoden aldrig körs.
 */
